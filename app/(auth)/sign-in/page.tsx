          ...
          <div className="w-full max-w-xs">
            <form className="flex flex-col">
              ...
              <div className="grid gap-3">
                ...
                <Button variant={'outline'} type="submit" className="flex w-full border shadow">
              ...
              <p className="text-center mt-3 text-muted-foreground text-sm text-balance">
                Don`t Have Account?, <Link className="text-primary underline" href={'/sign-up'}>Register Now</Link>
              </p>
            </form>
          </div>
        </div>
