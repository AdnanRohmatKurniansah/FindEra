...
import { useRegisterActions } from "../../../hooks/useRegister"
  ...
  return (
    <div className="grid min-h-svh lg:grid-cols-2">
      <div className="flex flex-col gap-4 p-6 md:p-8">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-xs">
            <form onSubmit={handleSubmit(signupEmail)} className="flex flex-col">
              ...
              <div className="flex flex-col items-center gap-2 text-center mb-5">
                ...
                <p className="text-muted-foreground text-sm text-balance">
                  Masukkan email mendaftar ke akun Anda
                </p>
              </div>
              <div className="grid gap-3">
                <div className="grid gap-3">
                  <Label htmlFor="name">Name</Label>
                  <Input {...register('name')} id="name" type="text" placeholder="Masukkan nama anda"  />
                  {errors.name && (
                ...
                <Button disabled={isSubmitting} type="submit" className="w-full">
                  Daftar <span className='ml-2'>
                      {isSubmitting && <Spinner />}
                    </span>
                </Button>
                <Button type="button" variant="outline"disabled={isSubmitting || isGoogleSubmitting} onClick={signupGoogle} className="w-full">
              ...
              <p className="text-center mt-3 text-muted-foreground text-sm text-balance">
                Sudah punya akun?, <Link className="text-primary underline" href={'/sign-in'}>Masuk Sekarang</Link>
              </p>
            </form>
          </div>
        </div>
      ...
      <div className="bg-muted relative hidden lg:block">
        <Image src={'/images/auth-img.jpg?v=1'} fill className="object-cover" alt={'authentication image'} />
      </div>
    </div>
  )
}
